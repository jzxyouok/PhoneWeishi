...
public class PrograssBarCircle extends View {
	 ...
	 */
	public PrograssBarCircle(Context context, AttributeSet attrs) {
		super(context, attrs);
		pathPaint  = new Paint();
		// 设置是否抗锯齿
	...
	public void setProgress(long progress) {
		...
		if(this.mOnProgressListener!=null){
			if(this.max <= this.progress){
				this.mOnProgressListener.onComplete();
			}else{
				this.mOnProgressListener.onProgress(progress);
			}
		}
	}
	@Override  
	 ...
	 */
	public OnProgressListener getAbOnProgressListener() {
